...
public class DotFileProcessMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable>{

	  /*
	   * Counters
	   */
	  private static final String GROUP = "GDB Add Dot Process";
	  ...
	  protected void map(LongWritable key, Text value, Context context) throws IOException,
	    ...
	    try {
	      processor.process('1',line); // process node line
	      jsonLines++;
	      if (jsonLines % 1024 == 0) {
