...
public class EdgeFileProcessMapper extends Mapper<LongWritable, Text, NullWritable, NullWritable>{

	  /*
	   * Counters
	   */
	  private static final String GROUP = "GDB Add Edge Process";
	  private static final String CNT_SUCCESS_LINE = "Success  Lines";
	  private static final String CNT_EXCEPTIONS = "Exceptions";

	  /*
	   * JSON Data processor
	   */
	  private GDBWeiboFileDataProcessor processor;
	  
	  private long jsonLines = 0;
	  private long lastReportedLines=0;

	  private long exceptionCounter = 0;
	  private static final int MAX_EXCEPTIONS = Integer.MAX_VALUE;
	  

	  @Override
	  protected void setup(Context context) throws IOException, InterruptedException {
	    processor = new GDBWeiboFileDataProcessor();
	    exceptionCounter = 0;
	  ...
	  protected void map(LongWritable key, Text value, Context context) throws IOException,
	    ...
	    try {
	      processor.process('2',line); // process node line
	      jsonLines++;
	      if (jsonLines % 1024 == 0) {
